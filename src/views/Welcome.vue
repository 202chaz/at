<template>
  <div class="md-layout md-gutter md-alignment-center-center">
    <div class="md-layout-item md-size-55 welcome">
      <md-content class="md-elevation-3">
        <p class="md-title">U. S. Government (USG) Information System (IS) - Use and Consent</p>
        ...
        <ul>
          <li>USG routinely intercepts and monitors communications on this IS for purposes including, but not limited to, penetration testing, COMSEC monitoring, network operations and defense, personnel misconduct (PM), law enforcement (LE), and counterintelligence (CI) investigations.</li>
          ...
          <li>Notwithstanding the above, using this IS does not constitute consent to PM, LE, or CI investigative searching or monitoring of the content of privileged communications, or work product, related to personal representation or services by attorneys, psychotherapists, or clergy, and their assistants. Such communication and work product are private and confidential. See User Agreement for details.</li>
        </ul>
        <md-button class="md-raised md-primary" to="/login">Accept</md-button>
        <md-button class="md-raised md-accent">Decline</md-button>
      </md-content>
    </div>
  </div>
</template>
